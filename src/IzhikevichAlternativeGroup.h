...
#ifndef IZHIALTERNATIVEGROUP_H_
#define IZHIALTERNATIVEGROUP_H_
 ...
 */
	class IzhikevichAlternativeGroup : public NeuronGroup
	{
	private:
	...
	public:
		 ...
		 * mechanism.
		 */
		IzhikevichAlternativeGroup( NeuronID size, AurynFloat load = 1.0, NeuronID total = 0 );
		virtual ~IzhikevichAlternativeGroup();
		void clear();
