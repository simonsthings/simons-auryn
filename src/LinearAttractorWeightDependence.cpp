...
LinearAttractorWeightDependence::LinearAttractorWeightDependence(AurynFloat theAttractorStrengthIndicator, AurynWeight theAttractorLocationIndicator)
		: attractorStrengthIndicator(theAttractorStrengthIndicator), attractorLocationIndicator(theAttractorLocationIndicator)
{
	compute_fudge();
}
LinearAttractorWeightDependence::LinearAttractorWeightDependence(AurynWeight w_max, AurynFloat scale_LTP, AurynFloat scale_LTD, AurynFloat theAttractorStrengthIndicator, AurynWeight theAttractorLocationIndicator)
...
void LinearAttractorWeightDependence::compute_fudge()
{
...
AurynDouble LinearAttractorWeightDependence::scalePreBeforePost(AurynWeight *weight)
{
	return scaleconstant_PreBeforePost * ( (w_max - *weight) * attractorStrengthIndicator + fudge_LTP );
}
AurynDouble LinearAttractorWeightDependence::scalePreAfterPost(AurynWeight *weight)
{
