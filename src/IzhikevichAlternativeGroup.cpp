...
IzhikevichAlternativeGroup::IzhikevichAlternativeGroup( NeuronID size, AurynFloat load, NeuronID total ) : NeuronGroup(size,load,total)
{
	sys->register_spiking_group(this);
	if ( evolve_locally() ) init();
}

void IzhikevichAlternativeGroup::calculate_scale_constants()
{
}

void IzhikevichAlternativeGroup::init()
{
	// BEGIN old stuff
...
void IzhikevichAlternativeGroup::clear()
{
	clear_spikes();
...
void IzhikevichAlternativeGroup::select_example_parameter_set(Izhikevich_DefaultParametersets paramsetchoice)
{
...
void IzhikevichAlternativeGroup::calculate_Izhikevich_coefficients(AurynDouble k, AurynDouble v_rest, AurynDouble v_thres, AurynDouble b)
{
...
void IzhikevichAlternativeGroup::free()
{
}
IzhikevichAlternativeGroup::~IzhikevichAlternativeGroup()
{
	if ( evolve_locally() ) free();
}
void IzhikevichAlternativeGroup::integrate_membrane_debug_two()
{
...
void IzhikevichAlternativeGroup::check_peaks()
{
...
void IzhikevichAlternativeGroup::evolve()
{
...
AurynState IzhikevichAlternativeGroup::get_t_exc(NeuronID i)
{
	return auryn_vector_float_get(t_exc,i);
}
AurynState IzhikevichAlternativeGroup::get_t_inh(NeuronID i)
{
	return auryn_vector_float_get(t_inh,i);
}
AurynState IzhikevichAlternativeGroup::get_v_temp(NeuronID i)
{
	return auryn_vector_float_get(v_temp,i);
}
AurynState IzhikevichAlternativeGroup::get_u_temp(NeuronID i)
{
	return auryn_vector_float_get(u_temp,i);
}
AurynState IzhikevichAlternativeGroup::get_u(NeuronID i)
{
	return auryn_vector_float_get(u,i);
}
AurynState IzhikevichAlternativeGroup::get_tempMemState(int i)
{
	return (AurynState)tempMemStates[i];
}

AurynFloat IzhikevichAlternativeGroup::get_projMult()
{
	return projMult;
}

void IzhikevichAlternativeGroup::set_projMult(AurynFloat the_projMult)
{
