...
int main(int ac, char* av[]) 
{
	...
	double pA = 1e-12;  // need to check what Auryn actually expects here.
	...
	NeuronID N_post = 1;
	Izhikevich2007Group* izhi_neuron = new Izhikevich2007Group(N_post);
	...
	double stepcurrent = 1.1 *1e3 *1e3;  // still not sure which order of mag this needs to be...
